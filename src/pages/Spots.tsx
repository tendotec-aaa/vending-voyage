 ...
 import { useSpotAnalytics, useLocationsForFilter } from "@/hooks/useSpotAnalytics";
 ...
 export default function Spots() {
   const { data: spots, isLoading } = useSpotAnalytics();
   ...
   const exportToCSV = () => {
     ...
     const headers = ["Rank", "Spot Name", "Location", "Total Sales", "Total Rent", "Net Profit", "ROI %", "Stock %", "Trend"];
